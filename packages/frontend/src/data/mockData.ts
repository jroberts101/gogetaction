...
export const mockCampaigns: Campaign[] = [
  {
    ...
    imageUrl: '/lovable-uploads/6e0b4fb1-fe23-4dc6-a53a-6d75a74fbbc1.png',
  ...
  },
  {
    ...
    imageUrl: '/lovable-uploads/85e867f9-8569-4700-b7a2-95ebe896951a.png',
  ...
  },
  {
    ...
    imageUrl: '/lovable-uploads/9fcaf34d-6d18-4840-abd5-b56cf5eaf986.png',
...
export const mockRecipients = [
  ...
  {
    id: 'r2',
    name: 'Representative John Davis',
  ...
  {
    id: 'r3',
    name: 'Governor Michael Johnson',
    address: '789 State House',
    city: 'Capital City',
    state: 'CA',
    zipCode: '94203',
  },
  ...
  {
    id: 'r5',
    name: 'Councilmember Robert Garcia',
    address: '202 Municipal Building',
    city: 'Riverside',
    state: 'CA',
    zipCode: '92501',
  },
  {
    id: 'r6',
    name: 'Secretary of Education Emily Wilson',
    address: '303 Education Department',
    city: 'Washington',
    state: 'DC',
    zipCode: '20003',
  },
  {
    id: 'r7',
    name: 'EPA Director David Martinez',
    address: '404 Environmental Way',
    city: 'Washington',
    state: 'DC',
    zipCode: '20004',
  },
  {
    id: 'r8',
    name: 'Commissioner Sarah Williams',
    address: '505 Commission St',
    city: 'Springfield',
    state: 'IL',
    zipCode: '62701',
  },
