...
- **Frontend Access:** Frontend code (Vite) can only access environment variables prefixed with VITE\_. These are embedded during the build process and are **publicly visible**. Do not put secrets here.
...
| 2.8                                               | **Create ** Create an .editorconfig file at the root.                                                                                                                                                                                                         | Defines basic coding styles (indentation, line endings) enforced across different editors/IDEs.                                                                                                             | .editorconfig file exists with project standards (e.g., indent_style = space, indent_size = 2, end_of_line = lf, charset = utf-8).                                                                                                                                                            |
...
| 7.6                                               | **Commit Initial Setup:** Run git add ., git commit -m "chore: initial project setup and tooling configuration". Push branch git push -u origin initial-setup.                                                                                                |
